...
annot_list = annot_list[["go_id"]]


annotation_final = annot_list[,2]

annotation_final = t(annotation_final)

annotation_final = as.data.frame(annotation_final)

names(annotation_final) = annot_list$ensembl_gene_id
...
probes_data = names(data_processed)
probes_annot = rownames(annotation_final)
probes2annot = match(probes_annot, probes_data)
...
geneInfo0 = data.frame(ensembl_gene_id = probes_annot,
                       wheatexp_gene = annotation_final$wheatexp_gene[probes2annot],
                       GO = annotation_final$V1[probes2annot],
